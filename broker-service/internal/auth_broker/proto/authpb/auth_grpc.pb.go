...
const (
	AuthService_CreateNewUser_FullMethodName  = "/authbroker.AuthService/CreateNewUser"
	AuthService_ChangeUserRole_FullMethodName = "/authbroker.AuthService/ChangeUserRole"
	AuthService_UserLogin_FullMethodName      = "/authbroker.AuthService/UserLogin"
	AuthService_GetAllUsers_FullMethodName    = "/authbroker.AuthService/GetAllUsers"
)
...
func (c *authServiceClient) UserLogin(ctx context.Context, in *UserLoginCredentials, opts ...grpc.CallOption) (*UserLoginResposne, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserLoginResposne)
...
func (UnimplementedAuthServiceServer) UserLogin(context.Context, *UserLoginCredentials) (*UserLoginResposne, error) {
...
func _AuthService_CreateNewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).CreateNewUser(ctx, req.(*NewUserRequest))
	}
...
func _AuthService_UserLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).UserLogin(ctx, req.(*UserLoginCredentials))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "authbroker.AuthService",
